    ...
    , ui(new Ui::PausaDialog)
{
    ...
    // Modificar los widgets existentes para que se ajusten bien
    if (ui->btnContinuar) {
        ui->btnContinuar->setFixedHeight(45); // Botones más altos
        ui->btnContinuar->setMinimumWidth(250); // Y más anchos
        layoutContenedor->addWidget(ui->btnContinuar, 0, Qt::AlignHCenter);
    }
    ...
    ui->btnContinuar->setCursor(Qt::PointingHandCursor);
